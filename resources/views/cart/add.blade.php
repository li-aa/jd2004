				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<img jqimg="/static/img/_/b1.png" src="{{env('UPLOAD_URL')}}{{$data->goods_img}}" width ="400" height="500"/>
							</span>
						</div>
						<!--下方的缩略图-->
						<div class="spec-scroll">
							...
							<div class="items">
								<ul>
									<li><img src="{{env('UPLOAD_URL')}}{{$data->goods_img}}" bimg="/static/img/_/b1.png" onmousemove="preview(this)" /></li>
									<li><img src="{{env('UPLOAD_URL')}}{{$data->goods_img}}" bimg="/static/img/_/b2.png" onmousemove="preview(this)" /></li>
									<li><img src="{{env('UPLOAD_URL')}}{{$data->goods_img}}" bimg="/static/img/_/b2.png" onmousemove="preview(this)" /></li>
									<li><img src="{{env('UPLOAD_URL')}}{{$data->goods_img}}" bimg="/static/img/_/b3.png" onmousemove="preview(this)" /></li>
								</ul>
							</div>
							<a class="next">&gt;</a>
						</div>
				...
				<div class="fr itemInfo-wrap">
					...
					<div class="summary">
						<div class="summary-wrap">
							...
							<div class="fl price">
								<i>¥</i>
								<em>{{$data->shop_price}}</em>
								<span>降价通知</span>
							</div>
							<div class="fr remark">
								<i>累计评价</i><em>{{$data->click_count}}</em>
							</div>
						</div>
						<div class="summary-wrap">
							<div class="fl title">
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<button id="btn_add" class="sui-btn  btn-danger addshopcar">加入购物车</button>
									</li>
								</ul>
							</div>
						</div>
