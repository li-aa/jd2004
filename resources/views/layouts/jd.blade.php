			...
			<div class="py-container">
				<div class="shortcut">
					<ul class="fl">
						...
						@if(isset($_COOKIE['reg_id']) && isset($_COOKIE['reg_name']))
						<li class="f-item">欢迎 {{$_COOKIE['reg_name']}} 登录
							<span><a href="{{url('/index/layout')}}">退出账号</a></span>
						</li>
						@else
						
						<li class="f-item">请<a href="{{url('/index/login')}}">登录</a><span>
							<a href="{{url('/index/register')}}">免费注册</a></span></li>
						@endif
					</ul>
					<ul class="fr">
				...
				<div class="yui3-g NavList">
					...
					<div class="yui3-u Center navArea">
						<ul class="nav">
							...
							<li class="f-item"><a href="{{url('/prize/add')}}" >抽奖</a></li>
						</ul>
					</div>
